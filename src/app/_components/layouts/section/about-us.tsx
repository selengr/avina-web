          ...
          >
            ...
            <div className="lg:w-[60%] lg:pr-[70px] xl:pr-[150px] lg:pl-[45px]">
              <h6 className="text-m-subtitle2 lg:text-d-subtitle1 lg:font-kalameh text-primary-text font-semibold pb-2 pt-6 xl:pt-12">
                تیمی که از ایده تا پشتیبانی کنار شماست.
              </h6>

              <Description className="text-justify">
                آوینا روی ساخت و نگهداری راهکارهای فناوری تمرکز دارد؛ از نرم‌افزار
                و سخت‌افزار تا شبکه و امنیت. هدف‌مان این است که ابزارها پیچیده
                نباشند، کار روزمره روان‌تر شود و بعد از تحویل هم پشتیبانی در دسترس
                بماند.
              </Description>
